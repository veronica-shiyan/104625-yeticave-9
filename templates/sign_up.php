<form class="form container <?= isset($errors) ? "form--invalid" : ""; ?>" action="" method="post"
    ...
    <div class="form__item <?= isset($errors['email']) ? "form__item--invalid" : ""; ?>">
        ...
        <input id="email" type="text" name="email" placeholder="Введите e-mail" value="<?= esc($value); ?>">
        <span class="form__error"><?= $errors['email']; ?></span>
    </div>
    <div class="form__item <?= isset($errors['password']) ? "form__item--invalid" : ""; ?>">
        <label for="password">Пароль <sup>*</sup></label>
        <?php $value = isset($_POST['password']) ? $_POST['password'] : "" ?>
        <input id="password" type="password" name="password" placeholder="Введите пароль" value="<?= esc($value); ?>">
        <span class="form__error"><?= $errors['password']; ?></span>
    </div>
    <div class="form__item <?= isset($errors['login']) ? "form__item--invalid" : ""; ?>">
        <label for="name">Имя <sup>*</sup></label>
        <?php $value = isset($_POST['login']) ? $_POST['login'] : "" ?>
        <input id="name" type="text" name="login" placeholder="Введите имя" value="<?= esc($value); ?>">
