...
INSERT INTO lots
SET created_at = (NOW() - INTERVAL 30 MINUTE), title = 'Маска Oakley Canopy', description = 'Горнолыжная маска Oakley Canopy идеально подходит для катания в солнечную погоду.', image = 'img/lot-6.jpg', starting_price = 7000, completed_at = (created_at + INTERVAL 28 HOUR), bet_step = 100, user_id = 1, category_id = 6;
